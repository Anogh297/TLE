...
class Paginated:
    ...
    async def paginate(self, bot, ctx, wait_time, delete_after: float = None):
        channel = ctx.channel or ctx
...
def paginate(
    ...
    *,
    ...
    asyncio.create_task(paginated.paginate(bot, ctx, wait_time, delete_after))
